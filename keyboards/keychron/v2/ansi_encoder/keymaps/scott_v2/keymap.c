...
const uint16_t PROGMEM ds_combo[] = {LCTL_T(KC_D), LALT_T(KC_S), COMBO_END};
...
const uint16_t PROGMEM dk_combo[] = {LCTL_T(KC_D), LCTL_T(KC_K), COMBO_END};
const uint16_t PROGMEM sl_combo[] = {LALT_T(KC_S), LALT_T(KC_L), COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_01] = LAYOUT_ansi_67(
        ...
        _______, _______,  KC_LEFT,  KC_DOWN, KC_RGHT, _______, _______, LSFT_T(KC_4),  LCTL_T(KC_5),   LALT_T(KC_6),   KC_PPLS,  _______,            _______,          KC_END,
